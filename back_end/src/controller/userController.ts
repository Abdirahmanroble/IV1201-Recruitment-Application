...
class UserController {
  ...
  public static async updateUser (req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const success = updateMessage === 'User updated successfully'
      if (success) res.json({ message: updateMessage, success })
  ...
  public static async emailConfirmation (req: Request, res: Response): Promise<void> {
    ...
    try {
      ...
      const url = `https://iv1201-recruitment-application.onrender.com/update-password/${token}`
